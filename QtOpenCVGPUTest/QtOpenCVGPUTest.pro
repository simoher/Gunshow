...
TARGET = QtOpenCVGPUTest
TEMPLATE = app

#By default the following file lists are updated automatically by VisualGDB.

SOURCES   += camera.cpp cameracontrol.cpp graphics.cpp lodepng.cpp picam.cpp
HEADERS   += camera.h cameracontrol.h graphics.h lodepng.h mmalincludes.h
FORMS     += 
RESOURCES += 
